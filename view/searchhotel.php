        ...
        <div class="rounded-md w-[80vw] flex flex-col gap-5 bg-slate-50 p-5 shadow-md">
            ...
            <div class="w-full">
                <div class="inline-flex flex-col justify-center relative text-gray-500 w-full">
                    ...
                    <div class="relative">
                        <input type="text" name="city_id" id="city_id" class="w-full p-2 pl-10 rounded border border-gray-300 focus:bg-white focus:outline-none focus:ring-2 focus:ring-yellow-600 focus:border-transparent" placeholder="search..." value="Gar" />
            ...
            <div class="flex w-full relative gap-4">
                ...
                <div class="w-1/3 text-gray-500">
                    ...
                    <div class="relative w-full mt-2">
                        <input type="date" name="checkin" id="checkin" class="date-input w-full p-2 pl-10 rounded border border-gray-300 focus:bg-white focus:outline-none focus:ring-2 focus:ring-yellow-600 focus:border-transparent" placeholder="search..." value="Gar" />
                ...
                <div class="w-1/3">
                    ...
                    <div class="relative w-full mt-2">
                        <input type="date" name="checkout" id="checkout" disabled class="date-input w-full rounded" placeholder="search..." value="Gar" />
                    </div>
                </div>
            </div>
            <!-- Guest and Rooms -->
