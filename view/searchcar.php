            ...
            <div class="w-full">
                ...
                <div class="flex items-center gap-4">
                    <div class="flex items-center gap-2">
                        <input type="radio" name="driver" checked id="withdriver" value="1" class="w-5 h-5" />
                        <label for="withdriver">With Driver</label>
                    </div>
                    <div class="flex items-center gap-2">
                        <input type="radio" name="driver" id="withoutdriver" value="0" class="w-5 h-5" />
            ...
            <div class="flex w-full relative gap-4">
                ...
                <div class="w-1/3 text-gray-500">
                    ...
                    <div class="relative w-full mt-2">
                        <input type="date" name="startdate" id="checkin" class="date-input w-full p-2 pl-10 rounded border border-gray-300 focus:bg-white focus:outline-none focus:ring-2 focus:ring-yellow-600 focus:border-transparent" placeholder="search..." />
                ...
                <div class="w-1/3">
                    ...
                    <div class="relative w-full mt-2">
                        <input type="date" name="enddate" id="checkout" class="w-full p-2 pl-10 rounded border border-gray-300 focus:bg-white focus:outline-none focus:ring-2 focus:ring-yellow-600 focus:border-transparent" placeholder="search..." />
                ...
                <div class="w-1/3 flex items-end">
                    ...
                    <!-- <a href="cars.php" class="w-full"> -->
                        <button id="search" class="w-full text-white p-2 rounded bg-orange-600 hover:bg-orange-700	font-bold flex items-center justify-center gap-1"><img src="https://d1785e74lyxkqq.cloudfront.net/_next/static/v2/6/68a17a4492b3b7647bb89a5a03b15de0.svg">
