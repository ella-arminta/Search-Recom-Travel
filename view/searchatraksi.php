        ...
        <div class="rounded-md w-[80vw] flex flex-col gap-5 bg-slate-50 p-5 shadow-md">
            ...
            <div class="w-full">
                <div class="inline-flex flex-col justify-center relative text-gray-500 w-full">
                    <label for="attractioname" class="pb-2">Attractions</label>
                    <div class="relative">
                    ...
                    <ul id="atraksiList" class="bg-white border border-gray-100 w-full mt-2 rounded top-16 absolute shadow-md hidden z-10">
            ...
            <div class="flex w-full relative gap-4">
                ...
                <div class="w-1/3">
                    ...
                    <div class="relative w-full mt-2">
                        <input type="date" name="tanggal" id="tanggal" class="w-full p-2 pl-10 rounded border border-gray-300 focus:bg-white focus:outline-none focus:ring-2 focus:ring-yellow-600 focus:border-transparent" placeholder="search..." />
